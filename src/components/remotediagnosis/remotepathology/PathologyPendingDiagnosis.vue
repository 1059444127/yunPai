...
import ViewDetail from "@/components/remotediagnosis/remotepathology/ViewDetail.vue";
...
export default class PathologyPendingDiagnosis extends Vue {
  // todo: 控制权限
  @Prop() admin: string;
