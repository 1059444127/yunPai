        ...
        <div class="view-dialog">
            ...
            <div class="dialog-content" id="dialog-content">
                ...
                <div class="dialog-info">
                  ...
                  <div class="dialog-info-content">
                    <div class="info-div">
                      <p class="info-item-content w-694"><span class="record-content-icon">●</span>{{submitState.dtAction}} {{submitState.actionOrgName}} {{submitState.actionDeptName}} {{submitState.actionOperateName}}<br>{{submitState.actionMemo}}</p>
                    </div>
                    <div class="submit">
...
export default class ConfirmReferral extends Vue {
  ...
  viewMedicalData() {
    ...
    window.open(
      `${rootPath}#/medicaldata?identityCardNo=${this.infoModel.identityCardNo}`
    );
  }
