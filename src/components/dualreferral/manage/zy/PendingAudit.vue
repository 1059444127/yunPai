<template>
  <div class="pending-audit-list">
      <div class="list-title">{{const_list.TabTitle.PendingAudit}}</div>
      <el-table
        :data="dataList"
        class="list-detail"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <span class="my-link-btn pointer" @click="auditReferralForm(scope.row.id)">{{const_list.ListTitle.Audit}}</span>
            <span class="my-separate-line">|</span>
...
export default class PendingAudit extends Vue {
  // todo: 控制权限
  @Prop() admin: string;
